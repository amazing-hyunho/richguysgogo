...
- 시장 기준일: **2026-03-08**
- 생성 시각(UTC): `2026-03-07T22:50:55.395534+00:00`

## 1) 한눈에 보기
- **위원회 합의**: 위원회는 선별적 포지셔닝을 전제로 중립적 입장을 유지합니다.
- **국면 투표**: NEUTRAL=7, RISK_ON=0, RISK_OFF=0
- **다수 국면**: NEUTRAL
...
## 3) 시장/매크로 스냅샷
- **국내 지수**: KOSPI +0.02% / KOSDAQ +3.43%
- **미국 지수**: S&P500 -1.33% / NASDAQ -1.59% / DOW -0.95%
- **환율/변동성**: USD/KRW 1483.74 (+0.15%) / VIX 29.5
- **시장 요약 노트**: KOSPI 0.02%, USD/KRW 1483.74. Headlines loaded. Flows unavailable.
- **수급 요약**: 외국인 +0억 / 기관 +0억 / 개인 +0억
- **일간 매크로**: 미10년 4.13% / 미2년 3.57% / 2-10 0.56%p / DXY 98.99
- **월간 매크로**: 실업률 4.40% / CPI YoY 2.83% / Core CPI YoY 2.95% / PMI n/a
- **분기/구조**: GDP QoQ 연율 1.40% / 기준금리 3.64% / 실질금리 1.78%
...
### 유동성
- 한줄 요약: 유동성 신호가 혼재되어 중립적 비중 관리가 적절합니다.
- 국면 태그: NEUTRAL / 신뢰도: LOW
- 핵심 주장: 유동성 지표가 방향성 없이 혼재되어 있습니다.
- 핵심 주장: 정책 민감도는 높지만 확증 신호는 부족합니다.
- 핵심 주장: 과도한 베팅보다 리스크 균형이 유효합니다.

## 6) 이견 사항
- 국면 태그: 다수=NEUTRAL, 소수=None, 에이전트=[none]
  - 의미: 다른 국면 태그의 이견은 없습니다.
