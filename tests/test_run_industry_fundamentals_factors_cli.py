...
SCRIPT = ROOT / "scripts" / "run_industry_fundamentals_factors.py"
DB_PATH = ROOT / "data" / "investment.db"


class RunIndustryFundamentalsFactorsCliDryRunTests(unittest.TestCase):
    ...
    def test_default_invocation_is_dry_run_and_has_no_side_effects(self) -> None:
        ...
        self.assertIn("run_industry_fundamentals_factors_dry_run_only", result.stdout)
