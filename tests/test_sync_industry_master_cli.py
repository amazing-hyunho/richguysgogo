...
SCRIPT = ROOT / "scripts" / "sync_industry_master.py"
DB_PATH = ROOT / "data" / "investment.db"


class SyncIndustryMasterCliDryRunTests(unittest.TestCase):
    ...
    def test_default_invocation_is_dry_run_and_has_no_side_effects(self) -> None:
        ...
        self.assertIn("sync_industry_master_dry_run_only", result.stdout)
