...
SCRIPT = ROOT / "scripts" / "run_industry_cycle_weekly.py"
DB_PATH = ROOT / "data" / "investment.db"


class RunIndustryCycleWeeklyCliDryRunTests(unittest.TestCase):
    ...
    def test_default_invocation_is_dry_run_and_has_no_side_effects(self) -> None:
        ...
        self.assertIn("run_industry_cycle_weekly_dry_run_only", result.stdout)
