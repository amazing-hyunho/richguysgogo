...
SCRIPT = ROOT / "scripts" / "run_industry_virtual_portfolio.py"
DB_PATH = ROOT / "data" / "investment.db"


class RunIndustryVirtualPortfolioCliDryRunTests(unittest.TestCase):
    ...
    def test_default_invocation_is_dry_run_and_has_no_side_effects(self) -> None:
        ...
        self.assertIn("run_industry_virtual_portfolio_dry_run_only", result.stdout)
