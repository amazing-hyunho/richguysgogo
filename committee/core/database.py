    ...
    *,
    ...
    with connect(db_path) as conn:
        conn.execute(
            ...
            {
                "date": date,
                "kospi_pct": None if kospi_pct is None else float(kospi_pct),
                "kosdaq_pct": None if kosdaq_pct is None else float(kosdaq_pct),
    ...
    with connect(db_path) as conn:
        conn.execute(
            ...
            """,
            {
                ...
                "oil_wti": None if oil_wti is None else float(oil_wti),
