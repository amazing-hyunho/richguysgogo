...
class MacroStub(PreAnalysisAgent):
    ...
    def run(self, snapshot: Snapshot) -> Stance:
        ...
        flow_total = snapshot.flow_summary.foreign_net + snapshot.flow_summary.institution_net
        data_unavailable = (
        ...
        elif "volatile" in snapshot.market_summary.note.lower() or flow_total <= -300:
            regime = RegimeTag.RISK_OFF
            confidence = ConfidenceLevel.MED
            claims = ["Macro tone is cautious.", "Volatility noted.", "Flow demand is weak."]
